...
" Declare theme name
let g:colors_name = "rat"

"}}}
" The Colors -----------------------------------------------{{{
" Define reusable colors
let s:black            = { "gui": "#1e2124", "cterm": "235"  }
let s:white            = { "gui": "#FFFFFF", "cterm": "231" }
let s:almostWhite      = { "gui": "#EEEEEE", "cterm": "255" }
let s:almostBlack      = { "gui": "#1c1c22", "cterm": "235" }
...
let s:lightTan         = { "gui": "#FFFFD7", "cterm": "230" }
