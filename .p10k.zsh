# Generated by Powerlevel10k configuration wizard on 2022-04-01 at 18:50 BST.
...
# angled separators, blurred heads, sharp tails, 1 line, compact, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=002
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=64
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=002
