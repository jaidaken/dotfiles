...
hi Normal guifg=#c5a85a guibg=#514f36
hi Comment guifg=#78acd6 guibg=NONE
hi Constant guifg=#a8ac2e guibg=NONE
hi String guifg=#1bd12d guibg=NONE
hi htmlTagName guifg=#b294bb guibg=NONE
hi Identifier guifg=#7eabd9 guibg=NONE
